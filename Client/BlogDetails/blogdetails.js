  ...
  fetch(`../../Server/api/getblog.php?id=${blogId}`)
    ...
    .then(data => {
      if (data.success) {
        ...
        `;
        document.querySelector('.blog-details-container').insertAdjacentHTML('beforeend', commentSectionHTML);
        ...
        const renderComment = (commentObj) => {
          ...
          // Edit comment
          menuOptions.querySelector(".edit-comment").addEventListener("click", () => {
          ...
          // Delete comment
            menuOptions.querySelector(".delete-comment").addEventListener("click", () => {
          ...
          if (text !== "") {
            ...
            .then(response => {
              if (response.success) {
                ...
                renderComment({ id: response.commentId, author: "You", comment: text });
                commentBox.value = "";
                count++;
                updateCommentCount();
              } else {
